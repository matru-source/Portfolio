...
const profileFields: FieldDef[] = [
  ...
  { key: 'photo', label: 'Primary Profile Photo', type: 'image', full: true },
  { key: 'photos', label: 'Additional Profile Photos (Hero Slideshow)', type: 'images', full: true },
...
export const SECTIONS: SectionDef[] = [
  ...
  { key: 'site', label: 'Home / site text', kind: 'object', fields: siteFields },
  {
    ...
    fields: [
      ...
      { key: 'image', label: 'Primary Screenshot / Cover Image', type: 'image', full: true },
      { key: 'images', label: 'Additional Dashboard Screenshots (Auto-Slideshow)', type: 'images', full: true },
  ...
  },
  {
    ...
    kind: 'list',
    labelKey: 'title',
    newItem: () => ({ key: uid(), title: 'New certificate', issuer: '', year: '', category: 'Data & Analytics', image: '', images: [] }),
    fields: [
      { key: 'title', label: 'Title', type: 'text' },
      { key: 'issuer', label: 'Issuer', type: 'text' },
      { key: 'year', label: 'Year', type: 'text' },
      { key: 'category', label: 'Category', type: 'select', options: ['Data & Analytics', 'Cybersecurity', 'Development', 'NCC'] },
      { key: 'image', label: 'Primary Certificate Image', type: 'image', full: true },
      { key: 'images', label: 'Additional Certificate Scans / Marksheets', type: 'images', full: true },
